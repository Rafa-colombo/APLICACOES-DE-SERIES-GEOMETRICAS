# APLICAÇÕES DE SÉRIES GEOMÉTRICAS UTILIZANDO PROGRAMAÇÃO EM PYTHON
Projeto conjunto de calculo 3, Estátistica e Física em python. Implementação de um programa que simula lançamento de uma bola e seus movimentos em um plano 3D.
